          ...
          <div class="col-md-12">
            ...
            <?php
              if(isset($_POST['submit'])) {
                ...
                if($title!="" && $percent!="" )
                {
                    $query ="INSERT INTO skills(title,percent) VALUES('$title','$percent')";
                    ...
                    if($result)
                    {
                      ...
                      <meta http-equiv="refresh" content="0; URL=manageskill.php?msg=csuccess" />
                        <?php
                        echo "Skill is added successfully.";
                    }
                    else 
                    {
                        echo "Skill couldn't added successfully.";
                    }
                }
              ...
              <form action="#" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="percent" placeholder="">
                  </div>
