...
<head>
    ...
    <meta name="description" content="Machhapuchhre Higher Seconday School">
    <!-- ========== Page Title ========== -->
    <title>Machhapuchhre Higher Seconday School</title>
    <!-- ========== Favicon Icon ========== -->
            ...
            <div class="row align-content-center">
                ...
                <div class="col-xl-7 col-lg-5 col-md-8">
                    <p class="marquee" style="color: #e9a846;"><span>
                        Due to Covid-19 we are taking onlince class on Zoom Application.</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark">
                <a class="navbar-brand" href="index.php">
                    ...
                    <h4 style="color:#0c0b39">MACHHAPUCHHRE</h4>
                </a>
